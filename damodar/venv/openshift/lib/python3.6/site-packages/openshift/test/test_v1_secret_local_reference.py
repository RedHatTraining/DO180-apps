...
from openshift.client.models.v1_secret_local_reference import V1SecretLocalReference


class TestV1SecretLocalReference(unittest.TestCase):
    """ V1SecretLocalReference unit test stubs """
    ...
    def testV1SecretLocalReference(self):
        """
        Test V1SecretLocalReference
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = openshift.client.models.v1_secret_local_reference.V1SecretLocalReference()
        pass
